    ...
    <div className="user-profile">
      <div className="profile-header">
        ...
        <div className="profile-join-date">
          <div className="item"><strong>Csatlakozott:</strong> {new Date(author.dateOfBirth).toLocaleDateString()}</div>
          <div className="item"><strong>Email:</strong> {author.email}</div>
        </div>
        <p className="profile-bio">{author.bio}</p>
      </div>

      <div className="profile-posts">
        <h2 className="posts-title">{author.username} posztjai</h2>
